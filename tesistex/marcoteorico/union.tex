...
\begin{figure}[H]
\centering
\includegraphics[scale=.5]{Imagenes/N1.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[scale=.5]{Imagenes/N4.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[scale=.5]{Imagenes/N5.pdf}
\caption{Movimientos de la vecindad N5}
\end{figure}

\item N6 \cite{Balas1998} Los autores utilizan varios teoremas para identificar pares $(u,v)$ de operaciones dentro de un bloque crítico que puedan llevar a mejorar la solución y a su vez identificar si se tiene que mover a $u$ justo antes de $v$(forward) o bien a $v$ justo antes de $u$ (backward).
\begin{figure}[H]
\centering
\includegraphics[scale=.5]{Imagenes/N6.pdf}
\caption{Los dos tipos de movimientos para un par $(u,v)$}
\end{figure}

\item N7 \cite{Zhang2007} Esta vecindad se plantea como una extensión de la N6 en la cual no solo se lleavan operaciones internas del bloque al inicio o final sino que las operaciones inicial y final también se llevan al interior del bloque.
\end{itemize}
