...
\begin{itemize}
    \item \textbf{Representación directa} Se almacena el orden de los trabajos en cada máquina.
    \item \textbf{Representación indirecta} Se almacena información con la que se puede construir una solución mediante un proceso de decodificación.
\end{itemize}
