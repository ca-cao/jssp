...
Esta asignación nos asegura que se mantega el orden de muchas operaciones pero convierte a la solución en activa. A continuación se muestra un ejemplo ilustrativo
