...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=3cm,
  ...
  \node[main node] (j00) {$M_0$}; 
  \node[main node] (j01)[right of=j00] {$M_2$};
  \node[main node] (j02)[right of=j01] {$M_1$};
  \node[main node] (S)[below left of=j00] {$S$};
  \node[main node] (j10) [below right of= S]{$M_0$}; 
  \node[main node] (j11)[right of=j10] {$M_2$};
  \node[main node] (j12)[right of=j11] {$M_1$};
