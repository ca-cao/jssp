...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=3cm,
  ...
  \node[main node] (JPM) {};
  \node (M0) [below of=JPM]{};
  \node[main node] (M)[below right of=JPM] {u};
  \node[main node] (E) [right of=M] {};
  \node[main node] (S) [right of=E] {v};
  ...
  \path[every node/.style={font=\sffamily\small,
    ...
    \path(M) edge [bend left=150] node[left=10mm,above=1mm]{forward} (S)
	(S) edge [bend left=150] node{backward} (M) ;   
