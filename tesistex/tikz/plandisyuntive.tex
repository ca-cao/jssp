...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=3cm,
 ...
 % \node[draw,dashed,rounded corners,fit= (j00) (j01) (j02)]{};
  ...
  \path[every node/.style={font=\sffamily\small,
  	...
  	(j12) edge node {} (s)
  	(j02) edge node {} (s)	
  	(j00) edge[->,green] node {}(j10)
  	(j02) edge[->,red] node {}(j12)
  	(j01) edge[->,blue] node {}(j11);

\begin{pgfonlayer}{background}
        \draw[rounded corners=1em,line width=6em,yellow!80,-,cap=round]
                (j00.center) -- (j01.center)--(j11.center)--(j12.center);
    \end{pgfonlayer}
%    (M) edge [-] node {} (E)
